...
/// same entity as the [`crate::prelude::Enemy`] component).
/// This component, also being inserted on the [`crate::prelude::Enemy`] entity, marks the descendant entity
...
#[derive(Component)]
/// A temporary storage component for the [`AnimationGraphHandle`] when spawning an [`crate::prelude::Enemy`]. This
...
/// [`crate::prelude::Enemy`] that marks the center of the hitbox of an melee attack, or the origin of the
